<?php
/**
 * Template slug: startup-book-landing-tpl.php
 * Full standalone landing page — no theme header/footer
 */
...
<title><?php wp_title('|', true, 'right'); ?>طريقك لبناء STARTUP | محمد حميدة</title>
<?php wp_head(); ?>
...
<style>
#wpadminbar{display:none!important;}html{margin-top:0!important;scroll-behavior:smooth;}
...
body{background:var(--black)!important;color:var(--white)!important;font-family:'Cairo',sans-serif!important;overflow-x:hidden;line-height:1.8;}
...
.gold{color:var(--gold);}
.gg{background:linear-gradient(135deg,var(--gold-light),var(--gold),var(--gold-dim));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;}
...
.stat-num{font-size:1.7rem;font-weight:900;color:var(--gold);display:block;line-height:1;margin-bottom:5px;}
.stat-label{font-size:0.72rem;color:var(--white-dim);}
...
.ben-title{font-weight:700;font-size:1rem;color:var(--white);margin-bottom:10px;}
.ben-desc{font-size:0.88rem;color:var(--white-dim);line-height:1.75;}
...
.test-name{font-weight:700;font-size:0.88rem;color:var(--white);display:block;}
.test-role{font-size:0.75rem;color:var(--white-dim);}
...
<div class="book-wrap"><div class="book-glow"></div><div class="book-mockup"><img src="https://files.easy-orders.net/1772291850377657490.jpeg" alt="طريقك لبناء STARTUP" class="book-img" loading="eager"/></div></div>
</div></div></section>
<div class="proof-strip"><div class="container"><div class="proof-inner">
...
<section class="pain-section"><div class="container">
...
<section class="solution-intro"><div class="container">
  <div class="slabel fade-up">الحل</div>
  <h2 class="hlg fade-up">مش كتاب تقرأه وتنساه.</h2>
  <div class="sol-box fade-up"><div class="qmark">"</div>
...
<section class="inside-section" id="inside"><div class="container">
...
<section class="author-section"><div class="container">
  <div class="slabel">عن المؤلف</div>
  <div class="author-card fade-up">
    <div class="author-img-wrap"><img src="https://files.easy-orders.net/1772315256999115238.jpeg" alt="محمد حميدة" class="author-photo" loading="lazy"/></div>
...
<section class="offer-section" id="offer"><div class="container">
  ...
  <div class="offer-card fade-up">
    <div class="offer-header">
      ...
      <div class="price-row"><span class="old-price">1000 جنيه</span><div style="display:flex;align-items:flex-start;gap:4px;"><span class="currency">EGP</span><span class="new-price">600</span></div></div>
    ...
    <div class="offer-body">
      ...
      <div class="offer-guar"><span class="guar-icon">🛡️</span><div class="guar-text"><strong>ضمان الرضا الكامل — 7 أيام</strong><p>قرأ الكتاب وما عجبكش؟ تواصل معانا خلال 7 أيام ورجعنالك فلوسك كاملة. من غير أسئلة، ومن غير تعقيد.</p></div></div>
...
<section class="countdown-section"><div class="container">
...
<section class="order-section" id="order"><div class="container">
  ...
  <div class="order-card fade-up">
    <div class="order-header">
      ...
      <div class="order-price-row"><span class="order-old">1000 ج.م</span><span class="order-new">600 ج.م</span></div>
    </div>
    <div class="order-body">
      ...
      <div class="qty-row"><span class="qty-label">عدد القطع</span><div class="qty-ctrl"><button class="qty-btn" onclick="changeQty(-1)">−</button><span class="qty-val" id="qtyVal">1</span><button class="qty-btn" onclick="changeQty(1)">+</button></div></div>
...
(function(){const KEY='startup_book_deadline';let deadline=localStorage.getItem(KEY);if(!deadline){deadline=Date.now()+(5*24*60*60*1000);localStorage.setItem(KEY,deadline);}function pad(n){return String(n).padStart(2,'0');}function tick(){const diff=parseInt(deadline)-Date.now();if(diff<=0){['cd-days','cd-hours','cd-mins','cd-secs'].forEach(id=>document.getElementById(id).textContent='00');return;}document.getElementById('cd-days').textContent=pad(Math.floor(diff/86400000));document.getElementById('cd-hours').textContent=pad(Math.floor((diff%86400000)/3600000));document.getElementById('cd-mins').textContent=pad(Math.floor((diff%3600000)/60000));document.getElementById('cd-secs').textContent=pad(Math.floor((diff%60000)/1000));}tick();setInterval(tick,1000);})();
(function(){let v=Math.floor(Math.random()*21)+30;function update(){v=Math.max(30,Math.min(70,v+Math.floor(Math.random()*7)-3));document.getElementById('viewersCount').textContent=v;document.getElementById('viewersCount2').textContent=v;setTimeout(update,Math.floor(Math.random()*8000)+7000);}document.getElementById('viewersCount').textContent=v;document.getElementById('viewersCount2').textContent=v;setTimeout(update,7000);})();
